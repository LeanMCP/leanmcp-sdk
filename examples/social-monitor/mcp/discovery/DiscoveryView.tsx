/**
 * DiscoveryView - Focused view for MCP Discovery tool
        ...
        <div className="min-h-screen bg-gray-50 text-gray-900">
            ...
            <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
                <div className="max-w-3xl mx-auto px-4 h-14 flex items-center justify-between">
                    <h1 className="font-semibold text-gray-900">MCP Discovery</h1>
                    <button
            ...
            <main className="max-w-3xl mx-auto px-4 py-6">
                ...
                {loading && mentions.length === 0 ? (
                    ...
                    <div className="text-center py-12">
                        <p className="text-gray-400 mb-4">No discussions found</p>
                    ...
                    <>
                        <p className="text-sm text-gray-500 mb-6">
                            {mentions.length} discussions found mentioning Model Context Protocol
                        </p>
