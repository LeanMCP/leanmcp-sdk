/**
 * MentionsView - Focused view for LeanMCP Mentions tool
 * Shows only direct mentions of LeanMCP without tabs
 */
...
export function MentionsView() {
    ...
    const { call: fetchMentions, loading, error } = useGptTool('getLeanMCPMentions');
        ...
        <div className="min-h-screen bg-gray-50 text-gray-900">
            ...
            <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
                <div className="max-w-3xl mx-auto px-4 h-14 flex items-center justify-between">
                    <h1 className="font-semibold text-gray-900">LeanMCP Mentions</h1>
                    <button
            ...
            <main className="max-w-3xl mx-auto px-4 py-6">
                ...
                {loading && mentions.length === 0 ? (
                    ...
                    <div className="text-center py-12">
                        <p className="text-gray-400 mb-4">No mentions found</p>
                    ...
                    <>
                        <p className="text-sm text-gray-500 mb-6">
                            {mentions.length} {mentions.length === 1 ? 'mention' : 'mentions'} of LeanMCP
                        </p>
