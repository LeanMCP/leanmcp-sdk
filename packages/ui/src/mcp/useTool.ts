...
import type { UseToolOptions, UseToolReturn, ToolState } from '@/types/mcp-types';
...
export function useTool<
  ...
  TResult = unknown,
>(toolName: string, options: UseToolOptions<TArgs, TResult> = {}): UseToolReturn<TArgs, TResult> {
